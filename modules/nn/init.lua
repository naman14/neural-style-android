...
torch.include('nn', 'utils.lua')

torch.include('nn', 'ErrorMessages.lua')
torch.include('nn', 'Module.lua')

torch.include('nn', 'Container.lua')
torch.include('nn', 'Concat.lua')
torch.include('nn', 'Parallel.lua')
torch.include('nn', 'Sequential.lua')
torch.include('nn', 'DepthConcat.lua')
...
torch.include('nn', 'BatchNormalization.lua')
torch.include('nn', 'Padding.lua')
...
torch.include('nn', 'AddConstant.lua')
torch.include('nn', 'Dropout.lua')
torch.include('nn', 'SpatialDropout.lua')
...
torch.include('nn', 'SpatialAdaptiveMaxPooling.lua')
...
torch.include('nn', 'SpatialUpSamplingNearest.lua')
...
torch.include('nn', 'VolumetricAveragePooling.lua')
...
torch.include('nn', 'SelectTable.lua')
torch.include('nn', 'MixtureTable.lua')
torch.include('nn', 'CriterionTable.lua')
torch.include('nn', 'FlattenTable.lua')
...
torch.include('nn', 'L1Penalty.lua')
torch.include('nn', 'WeightedMSECriterion.lua')
torch.include('nn', 'BCECriterion.lua')
torch.include('nn', 'CrossEntropyCriterion.lua')
torch.include('nn', 'ParallelCriterion.lua')

torch.include('nn', 'StochasticGradient.lua')

torch.include('nn', 'MM.lua')

torch.include('nn', 'Jacobian.lua')
torch.include('nn', 'SparseJacobian.lua')
